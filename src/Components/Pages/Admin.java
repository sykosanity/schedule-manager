...
@SuppressWarnings("unchecked")
    ...
    private void DeleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteButtonActionPerformed
        ...
        // Step 3: If confirmed, delete rows
        if (response == javax.swing.JOptionPane.YES_OPTION) {
            // Reverse loop to prevent index shifting during deletion
    ...
    private void insertToRow(JTable table) {
        DefaultTableModel model = (DefaultTableModel) table.getModel();

        model.addRow(new Object[]{false, "Bien Niño Enric N. Iligan", "Dean", "Computer Programming"});
        model.addRow(new Object[]{false, "Keegan Jeoff G. Liboon", "Professor", "Computer Programming"});
        model.addRow(new Object[]{false, "John Bennedict B. Bancruz", "Teacher", "Computer Programming"});
    }
